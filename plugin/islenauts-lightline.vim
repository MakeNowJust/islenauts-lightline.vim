...
let s:p.normal.left     = [[s:black, s:blue]    , [s:white, s:gray2]]
let s:p.normal.middle   = [[s:white, s:gray4]]
let s:p.normal.right    = [[s:black, s:blue]    , [s:white, s:gray2]]
let s:p.inactive.left   = [[s:black, s:gray2]   , [s:gray4, s:gray1]]
let s:p.inactive.middle = [[s:gray4, s:gray1]]
let s:p.inactive.right  = [[s:black, s:gray2]   , [s:gray4, s:gray1]]
let s:p.insert.left     = [[s:black, s:green]   , [s:green, s:gray2]]
let s:p.insert.right    = [[s:black, s:green]   , [s:white, s:gray1]]
let s:p.replace.left    = [[s:black, s:yellow]  , [s:yellow, s:gray2]]
let s:p.replace.right   = [[s:black, s:yellow]  , [s:white, s:gray2]]
let s:p.visual.left     = [[s:white, s:magenta] , [s:magenta, s:gray2]]
let s:p.visual.right    = [[s:white, s:magenta] , [s:white, s:gray2]]
